...
- **월별 출석 일지 자동 생성**: 연·월별 일지를 자동으로 만들고 해당 날짜에 출석을 기록
- **관리자 페이지**: 명단 업로드, 출석 현황 조회·정정, 엑셀 내보내기
...
4. **Access Admin Page**
   ...
   서비스 흐름과 운영 방법은 `http://localhost:8080/사용법.html`에서 확인할 수 있습니다.
...
- 활성 명단: `data/userlist/attendance-roster.xlsx`
- 월별 출석 일지: `data/attendance/무료급식 일일 식사내역_26.8_일지.xlsx`
- 월이 바뀌면 첫 출석·조회·관리 시 새 일지를 자동 생성합니다.
</details>
